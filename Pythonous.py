...
print(f"""
{Fore.RED}     ____        __  __                                 ___________
    / __ \__  __/ /_/ /_  ____  ____  ____  __  _______/ ____/ ___/
   / /_/ / / / / __/ __ \/ __ \/ __ \/ __ \/ / / / ___/ /_   \\__ \\ 
  / ____/ /_/ / /_/ / / / /_/ / / / / /_/ / /_/ (__  ) __/  ___/ / 
 /_/    \__, /\__/_/ /_/\____/_/ /_/\____/\__,_/____/_/    /____/  
       /____/                                                     
{Style.RESET_ALL}

{Fore.RED}Server: https://discord.gg/GxAseruPHn
{Fore.RESET}------------------------------------------------------------

{Fore.RED}[1] {Fore.RESET}Spammer            {Fore.RED}[7] {Fore.RESET}About/Status Change    {Fore.RED}[13] {Fore.RESET}Mass Report
{Fore.RED}[2] {Fore.RESET}DM Spammer         {Fore.RED}[8] {Fore.RESET}Joiner                 {Fore.RED}[14] {Fore.RESET}Server Nuker
{Fore.RED}[3] {Fore.RESET}Friend Spammer     {Fore.RED}[9] {Fore.RESET}Leaver                 {Fore.RED}[15] {Fore.RESET}Account Nuker
{Fore.RED}[4] {Fore.RESET}Reaction Spammer   {Fore.RED}[10] {Fore.RESET}Token Checker         {Fore.RED}[16] {Fore.RESET}Token Bruteforcer
{Fore.RED}[5] {Fore.RESET}Webhook Spammer    {Fore.RED}[11] {Fore.RESET}Token Onliner         {Fore.RED}[17] {Fore.RESET}About
{Fore.RED}[6] {Fore.RESET}Typing Spammer     {Fore.RED}[12] {Fore.RESET}HypeSquad Joiner      {Fore.RED}[18] {Fore.RESET}Exit

------------------------------------------------------------
""")

try:
    choice = int(input(f"{Fore.RED}[ {Fore.WHITE}FS{Fore.RED} ]{Fore.RESET} "))
except ValueError:
    print(f"{Fore.RED}[ERROR]{Fore.RESET} Invalid input! Please enter a number.")
        ...
        def spam(token, mess):
            ...
            while True:
                ...
                if src.status_code == 429:
                    ...
                    print(f"{Fore.RED}[-] {Fore.RESET}Ratelimit for", str(float(ratelimit['retry_after'])) + " seconds")
                    time.sleep(float(ratelimit['retry_after']))

                elif src.status_code == 200:
                    print(f'{Fore.RED}[+] {Fore.RESET}{mess} sent')

                elif src.status_code == 401:
                    print(f'{Fore.RED}[-] {Fore.RESET}Invalid token')
                elif src.status_code == 404:
                    print(f'{Fore.RED}[-] {Fore.RESET}Not found ¯\_(ツ)_/¯')
                elif src.status_code == 403:
                    print(f'{Fore.RED}[-] {Fore.RESET}Token havent got access to this channel')
        ...
        def DMSpammer(idd, message, token):
            ...
            while True:
                ...
                if r2.status_code == 429:
                    ...
                    print(f"{Fore.RED}[+] {Fore.RESET}DM sent to {idd}!")
        ...
        def friender(token, user):
            try:
                ...
                if src.status_code == 204:
                    print(f"{Fore.RED}[+] {Fore.RESET}Friend request sent to {user[0]}#{user[1]}!")
        ...
        def reaction(chd, iddd, start, org, token):
            ...
            if start == '':
                ...
                if a.status_code == 204:
                    print(f"{Fore.RED}[+]{Fore.RESET} Reaction {org} added! ")
                else:
                    print(f"{Fore.RED}[-]{Fore.RESET} Error")

            else:
                print(f'{Fore.RED}[-]{Fore.RESET} ERROR, press only ENTER')
            ...
            while True:
                try:
                    ...
                    if _data.status_code == 204:
                        print(f"{Fore.RED}[+] {Fore.RESET}{message} sent")
                except:
                    print(
                        f"{Fore.RED}[-]{Fore.RESET} Error, or wrong webhook: {Fore.RED}{webhook}{Fore.RESET}")
                    time.sleep(5)
    ...
    if choice == 6:
        ...
        print(f"{Fore.RED}10 seconds to typing spam{Fore.RESET}")

        for seconds in range(10, 0, -1):
            print(seconds)
            time.sleep(1)
        print(f'{Fore.RED}[+]{Fore.RESET} Spamming')
        ...
        print(f"{Fore.RED}[+]{Fore.RESET} Done\n")
    ...
    if choice == 7:
        ...
        print(f'{Fore.RED}[1]{Fore.RESET} About Changer')
        print(f'{Fore.RED}[2]{Fore.RESET} Status Changer')
        changg = int(input('[?]>'))
        if changg == 1:
        ...
        if changg == 2:
            ...
            print(f'{Fore.YELLOW}Tokens must be online to see status{Fore.RESET}')
            text = input('Status: ')
    ...
    if choice == 9:
        ...
        with open('tokens.txt', 'r') as handle:
            ...
            print(f'{Fore.RED}[+]{Fore.RESET} Successfully left guild')
                    ...
                    with open('tokens.txt', 'r') as tokens:
                        ...
                        for token in filtered:
                            if len(token) > 15 and token not in checked and checker(token) == True:
                                print(f'{Fore.RED}[+] {Fore.RESET}{token} Valid')
                    ...
                    if len(checked) > 0:
                        ...
                        if save == 'y':
                            ...
                            with open(f'{name}.txt', 'w') as saveFile:
                                saveFile.write('\n'.join(checked))
                            print(f'{Fore.RED}[+]{Fore.RESET} Tokens saved to {name}.txt file!')
                except:
                    print(f'{Fore.RED}[-]{Fore.RESET} Error, cant open tokens.txt file...... :(!')
    ...
    if choice == 11:
        ...
        def activity(token, act):
            ...
            print(f'{Fore.RED}[+]{Fore.RESET} Activity Status: {act}')
    ...
    if choice == 12:
        ...
        print(f'''{Fore.LIGHTGREEN_EX}[1] {Fore.RESET}{Fore.MAGENTA}Bravery{Fore.RESET}
{Fore.LIGHTGREEN_EX}[2] {Fore.RESET}{Fore.LIGHTGREEN_EX}Brilliance{Fore.RESET}
{Fore.LIGHTGREEN_EX}[3] {Fore.RESET}{Fore.LIGHTCYAN_EX}Balance{Fore.RESET}
{Fore.LIGHTGREEN_EX}[4] {Fore.RESET}Leave The HypeSquad''')
    ...
    if choice == 13:
        ...
        sent = 0
        session = Session()
        print(f'{Fore.RED}[1]{Fore.RESET} Illegal Content')
        print(f'{Fore.RED}[2]{Fore.RESET} Harrassment')
        print(f'{Fore.RED}[3]{Fore.RESET} Spam or Phishing Links')
        print(f'{Fore.RED}[4]{Fore.RESET} Self harm')
        print(f'{Fore.RED}[5]{Fore.RESET} NSFW Content')
        ...
        if r.status_code == 200:
            ...
            print(f"{Fore.RED}[-]{Fore.RESET} Invalid Token{Fore.RESET}")
            input()
        id = input("Server ID: ")
        ...
        def Main():
            ...
            while True:
                ...
                if r.status_code == 201:
                    print(f"{Fore.RED}[+]{Fore.RESET} Sent Report{Fore.RESET} \n")
                    sent += 1
    ...
    if choice == 14:
        ...
        print(f'{Fore.RED}[1]{Fore.RESET} Account server Nuker')
        print(f'{Fore.RED}[2]{Fore.RESET} Bot server Nuker')
        ...
        if choicee1 == 1:
            ...
            print(f'{Fore.RED}[1] {Fore.RESET}Nuker')
            print(f'{Fore.RED}[2] {Fore.RESET}MassBan/MassKick')
            choicr = int(input('[?]>'))
            ...
            if choicr == 1:
                        ...
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(
                                        f"{Fore.RED}[+] {Fore.RESET}Deleted Channel {channel}")
                                    break
                                else:
                                    break
                    ...
                    def DeleteRoles(self, guild, role):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(
                                        f"{Fore.RED}[+] {Fore.RESET}Deleted Role {role}")
                                    break
                                else:
                                    break
                    ...
                    def SpamChannels(self, guild, name):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(f"{Fore.RED}[+]{Fore.RESET} Created Channel ")
                                    break
                                else:
                                    print(f'{Fore.RED}[-]{Fore.RESET} You cant create channels')
                    ...
                    def SpamRoles(self, guild, name):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(f"{Fore.RED}[+]{Fore.RESET} Created Role ")
                                    break
                                else:
                                    print(f'{Fore.RED}[-]{Fore.RESET} You cant create roles')
                                    break
                ...
                exit = spammer()
            if choicr == 2:
                print(f'{Fore.RED}Warning!{Fore.RESET} If you use MassBan or MassKick with a token where the mobile number is not verified, the token will be locked automatically and you will have to verify it.')
                ...
                class MassBan:
                    ...
                    def BanMembers(self, guild, member):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(f"{Fore.RED}[+]{Fore.RESET} Banning {member}")
                                    break
                                else:
                                    break
                    ...
                    def KickMembers(self, guild, member):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(f'{Fore.RED}[+]{Fore.RESET} Kicking {member}')
                                    break
                                else:
                                    break
                    ...
                    async def Menu(self):
                        print(f'{Fore.RED}[1]{Fore.RESET} MassBan')
                        print(f'{Fore.RED}[2]{Fore.RESET} MassKick')
        ...
        if choicee1 == 2:
            ...
            MAX_CHANNELS = 500
            print(f'{Fore.RED}[1]{Fore.RESET} Nuke')
            print(f'{Fore.RED}[2]{Fore.RESET} MassBan')
            ...
            if choicee == 1:
                ...
                print(f'{Fore.RED}For nuke write to chat: !Nuke{Fore.RESET}')


            if choicee == 2:
                reason = input('Bans reason: ')
                print(f'{Fore.RED}For for banning one guy write to chat: !OneBan{Fore.RESET}')
                print(f'{Fore.RED}For mass ban write to chat: !Ban{Fore.RESET}')
            ...
            async def Nuke(ctx):
                ...
                for role in guild.roles:
                    try:
                        await role.delete()
                        print(f'{Fore.RED}[+] {Fore.RESET}{role.name} Has been deleted{Fore.RESET}')
                    except:
                        print(f'{Fore.RED}[-] {Fore.RESET}{role.name} Has not been deleted')


                for channel in guild.channels:
                    try:
                        await channel.delete()
                        print(f'{Fore.RED}[+] {Fore.RESET}{channel.name} Has been deleted')
                    except:
                        print(f'{Fore.RED}[-]{Fore.RESET} You cant delete {channel}')


                try:
                    for i in range(MAX_CHANNELS):
                        await guild.create_text_channel(chanless)
                        print(f'{Fore.RED}[+] {Fore.RESET}{chanless} has been created')
                except:
                    print(f'{Fore.RED}[-]{Fore.RESET} You havent got permission to create channels')
            ...
            async def Ban(ctx):
                ...
                for member in list(client.get_all_members()):
                    try:
                        ...
                        print(f'{Fore.RED}[+]{Fore.RESET} User '+member.name+" has been banned")
                    except:
                        print(f'{Fore.RED}[-]{Fore.RESET} You havent got permission to ban :(')
            ...
            async def OneBan(ctx, member : discord.Member):
                ...
                try:
                    ...
                    print(f'{Fore.RED}[+]{Fore.RESET} {member} was banned')
                except:
                    print(f'{Fore.RED}[-]{Fore.RESET} You dont have permission to ban {member}')
            ...
            async def on_guild_channel_create(channel):
                while True:
                    try:
                        ...
                        print(f'{Fore.RED}[+]{Fore.RESET} SPAMMIMG :)')

                    except:
                        print(f'{Fore.RED}[-]{Fore.RESET} You cant spam')
    ...
    if choice == 15:
        ...
        print(f'''{Fore.RED}[1]{Fore.RESET} Server spam
{Fore.RED}[2]{Fore.RESET} Remove all friends
{Fore.RED}[3]{Fore.RESET} Block all friends
{Fore.RED}[4]{Fore.RESET} Spam settings
{Fore.RED}[5]{Fore.RESET} Leave all servers
{Fore.RED}[6]{Fore.RESET} Close all DMs
{Fore.RED}[7]{Fore.RESET} Send mass DM
{Fore.RED}[8]{Fore.RESET} Delete all personal Servers''')
        ...
        def remove_friends(Token):
            ...
            for i in remove_friends_request:
                ...
                print(f"{Fore.RED}[+] {Fore.RESET}Removed Friend {i['id']}")
        ...
        def block_friends(Token):
            ...
            for i in block_friends_request:
                ...
                print(f"{Fore.RED}[+] {Fore.RESET}Blocked Friend {i['id']}")

        def settings(Token):
            print(f'{Fore.RED}[+] {Fore.RESET}Starting')
        ...
        def server_leave(Token):
            ...
            for guild in leave_all_servers_request:
                ...
                print(f"{Fore.RED}[+] {Fore.RESET}Left Guild: {guild['id']}")
        ...
        def mass_dm(Token):
            ...
            for channel in mass_dm_request:
                ...
                print(f"{Fore.RED}[+] {Fore.RESET}Sent DMs to {channel['id']}")

        def delete_servers(Token):
            headers = {"authorization": Token, "user-agent": "Mozilla/5.0"}
            print(f"{Fore.RED}[+] {Fore.RESET} Deleting...")
            ...
            while id_to_token == id_to_token:
                ...
                try:
                    if login.status_code == 200:
                        print(f'{Fore.RED}[+]{Fore.RESET} VALID' + ' ' + token)
                        f = open('grab.txt', "a+")
                        f.write(f'{token}\n')
                    else:
                        print(f'{Fore.RED}[-]{Fore.RESET} INVALID' + ' ' + token)
    ...
    if choice == 17:
        ...
        print(f'''{Fore.RED}Wassup buddy. This is fun made tool by Lososik...      
